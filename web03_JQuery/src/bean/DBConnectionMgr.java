...
public class DBConnectionMgr {
    private Vector connections = new Vector(10); // Connection 10개 만듬
    private String _driver = "com.mysql.cj.jdbc.Driver", // 내 드라이버
    _url = "jdbc:mysql://localhost:3306/shop?useUnicode=true&serverTimezone=Asia/Seoul", // 내 db 주소
    _user = "root", // 내 db id
    _password = "1234"; // 내 db password
