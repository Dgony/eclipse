...
<body bgcolor="yellow">
<!-- 모델로 views/one.jsp까지 전달한 데이터를 받아서 꺼내서 출력 -->
<%
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                ...
                <td><%= dto.getName() %></td>
                <td><%= dto.getUrl() %></td>
                <td><img src="resources/img/<%= dto.getImg() %>"></td> <!-- Added content for the fourth column -->
            </tr>
        </tbody>
    </table>
    
    <a href="list">
    	<button class = "btn btn-primary">상품 전체 목록으로</button>
    </a>
    <hr>
    <a href="index.jsp">
