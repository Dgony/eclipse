...
<html>
  <head>
    ...
    <script async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDgRxmXyt4dxpJikT1haYtAv2gSakSuGE8&callback=console.debug&libraries=maps,marker&v=beta">
    </script>
